...
static int et055wu01_init_sequence(struct hx8399 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, HX8399_CMD_SETMIPI,
	...
	/* Unknown command, not listed in the HX8399-C datasheet */
	mipi_dsi_dcs_write_seq(dsi, HX8399_CMD_UNKNOWN1,
			       0x1f, 0x31);
	...
	/* Unknown command, not listed in the HX8399-C datasheet */
	mipi_dsi_dcs_write_seq(dsi, HX8399_CMD_UNKNOWN3,
			       0x02);
